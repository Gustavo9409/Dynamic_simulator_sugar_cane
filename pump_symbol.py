...
class BlockItem_Pump(QGraphicsRectItem):
	""" 
	...
	def __init__(self, name_block='Untitled',edit=None, parent=None):
		super(BlockItem_Pump, self).__init__(parent)
		self.editor=edit
		w = 92.0
		h = 66.0
		# Properties of the rectangle:
		self.setPen(QtGui.QPen(Qt.NoPen)) 
		Img= QtGui.QImage(dir_script+"\Images\Pump.png"); 
	...
	def changeSize(self, w, h):
		...
		self.inputs[1].setPos((w/2)-3, 0)
		self.inputs[1].block_pos=[w,(w/2)-3,h, 0]

		self.outputs[0].setPos(w+4, (h/2)-5)
		self.outputs[0].block_pos=[w,w+4,h, (h/2)-5]
